# Requirements Archive: v4.0 Status & Settings
...
- [x] **SETT-01**: Bot creates a dedicated "Settings" topic in the Telegram group
- [x] **SETT-02**: Settings topic displays inline keyboard with toggle buttons for each setting
- [x] **SETT-03**: Sub-agent visibility toggle available in settings
- [x] **SETT-04**: Permission mode selection available in settings
- [x] **SETT-05**: Settings changes take effect immediately without bot restart
- [x] **SETT-06**: Settings persist to disk and survive bot restarts
- [x] **SETT-07**: Only bot owner can modify settings (auth guard on callbacks)
